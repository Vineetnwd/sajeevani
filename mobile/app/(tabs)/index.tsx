...
export default function LeadSubmissionScreen() {
  ...
  // Example Local: 'http://192.168.x.x/sanjeevni/web/api/leads.php?action=submit_lead'
  const API_URL = 'http://192.168.1.100/sanjeevni/web/api/leads.php?action=submit_lead';
  ...
  const submitLead = async () => {
    ...
    data.append('executive_id', '1'); // Hardcoded until we complete login
